            ...
            <form class="form-horizontal tasi-form" method="post" action="">
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <input type="text" name="form[name]" id="name" maxlength="80" class="form-control" value="<?php echo $result['name']?>" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-6 d-flex align-items-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[status]" id="status0" value="0" <?php echo ($result['status'] == 0) ? 'checked' : ''?>>
                            <label class="form-check-label" for="status0">否</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[status]" id="status1" value="1" <?php echo ($result['status'] == 1) ? 'checked' : ''?>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-6 d-flex align-items-center">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[icon_status]" id="icon_status0" value="0" <?php echo ($result['icon_status'] == 0) ? 'checked' : ''?>>
                            <label class="form-check-label" for="icon_status0">否</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[icon_status]" id="icon_status1" value="1" <?php echo ($result['icon_status'] == 1) ? 'checked' : ''?>>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <div class="upload-picture-card"><?php echo $form->attachment('gif|jpg|png','1','form[icon_img]',$result['icon_img']);?></div>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <?php
                        echo $form->select(key_value($models,'modelid','name'), $result['modelid'], 'name="form[modelid]" class="form-select" datatype="*" errormsg="请选择模型！"',"≡ 请选择模型 ≡");
                        ?>
                    </div>
                </div>
                <div class="row mb-3">
