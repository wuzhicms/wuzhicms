		...
		<form id="myform" name="myfrom" class="form-horizontal tasi-form" method="post" action="index.php?m=member&f=group&v=add<?php echo $this->su();?>">
			...
			<table class="table table-striped table-advance table-hover">
				...
				<tr>
					...
					<td>
						<div class="col-lg-4 col-sm-6 col-xs-6 input-group"><input type="text" name="info[name]" class="form-control" placeholder="请输入组名" datatype="/^[a-z\d\u4E00-\u9FA5\uf900-\ufa2d][a-z\d_\u4E00-\u9FA5\uf900-\ufa2d]*[a-z\d\u4E00-\u9FA5\uf900-\ufa2d]$/i" errormsg="组名为2-15位数字、字母、汉字和_组成，且不能以_开头或结尾" sucmsg="OK" ajaxurl="index.php?m=member&f=group&v=check_name<?php echo $this->su();?>"/></div>
					</td>
				</tr>
				<tr>
					<td class="col-sm-2 col-xs-4 text-right"><label class="control-label">排序</label></td>
					<td>
						<div class="col-lg-4 col-sm-6 col-xs-6 input-group"><input type="text" name="info[sort]" class="form-control" placeholder="排序 0-255" datatype="n" errormsg="排序为0-255" sucmsg="OK" /></div>
					</td>
				</tr>
				<tr>
					<td class="col-sm-2 col-xs-4 text-right"><label class="control-label">最小积分</label></td>
					<td>
						<div class="col-lg-4 col-sm-6 col-xs-6 input-group"><input type="text" name="info[points]" class="form-control" placeholder="请输入最小积分" datatype="n" errormsg="请输入最小积分" sucmsg="OK" /></div>
					</td>
				</tr>
				<tr>
					<td class="col-sm-2 col-xs-4 text-right"><label class="control-label">自主升级</label></td>
					<td>
						<div class="col-lg-4 col-sm-6 col-xs-6 input-group"><input type="checkbox" name="info[upgrade]"  value="1"/></div>
					</td>
				</tr>
				<tr>
