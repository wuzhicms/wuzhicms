...
class WUZHI_alipay {
     ...
     * @return 提交表单HTML文本
     */
    function build_form($c, $method, $button_name,$tosubmit = 1,$target = '') {
        if($c['service_type']==2) {//即时到帐
            $para_temp = array(
                ...
                "seller_email"	=> $this->alipay_config['alipay_account'],
                "out_trade_no"	=> $c['order_no'],
                "subject"	=> $c['payname'],
            ...
            $para_temp = array(
                ...
                "price"	=> $c['price'],
                "quantity"	=> $c['quantity'],
                "logistics_fee"	=> $c['logistics_fee'],
                "logistics_type"	=> $c['logistics_type'],
                "logistics_payment"	=> $c['logistics_payment'],
                ...
                "receive_zip"	=> $c['receive_zip'],
                "receive_phone"	=> $c['receive_phone'],
                "receive_mobile"	=> $c['receive_mobile'],
        ...
        $sHtml = "<form id='alipaysubmit' name='alipaysubmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."' ".$target.">";
