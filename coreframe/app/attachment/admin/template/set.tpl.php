...
<div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label"><?php echo L('show_mode');?></label>
			...
			<div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label"><?php echo L('test_attachment');?></label>
                <div class="col-sm-4">
			...
			<div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label"><?php echo L('test_attachment_thumb');?></label>
			...
			<div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label"><?php echo L('test_attachment_more');?></label>
