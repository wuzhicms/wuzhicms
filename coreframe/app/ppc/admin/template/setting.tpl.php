                ...
                <div class="panel-body">
                    <form class="form-horizontal tasi-form" method="post" action="">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">推广页面地址</label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">积分奖励</label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">积分兑换商品地址</label>
                            <div class="col-sm-8 input-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">会员复制推广链接提示语</label>
                            <div class="col-sm-8 input-group">
