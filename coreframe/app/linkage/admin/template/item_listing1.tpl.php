...
<!-- page start-->
    <section class="panel">
        ...
        <div id="position" class="p-3 d-flex justify-content-between">
            <span>当前位置：<?php echo $data['name'].' > '.$this->current_pos($pid);?></span>
            <span class="text-danger">城市域名:只能绑定到城市,不能绑定到省和区</span>
        </div>
            ...
            <div class="panel-body" id="panel-bodys">
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tr>
                        ...
                        <th class="tablehead"><?php
                            if($pid==0) {
                                echo '省份';
                            } elseif($pid!=0 && $data2['pid']==0) {
                                echo '城市';
                            } else {
                                echo '区/乡镇';
                            }?></th>
                        <th class="tablehead">城市域名</th>
