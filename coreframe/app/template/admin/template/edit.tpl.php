    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="d-flex justify-content-between">
                ...
                <span>文件路径：<?php echo $dir.'/'.$file.$ext;?></span>
            </div>
            <div class="pt-2"><span class="help-block"><i class="icon-info-circle"></i> F11按键: 全屏编辑； ESC: 取消全屏； Ctrl+G: 跳至指定行；Ctrl+Z: 撤销</span></div>
            <form name="myform" method="post" id="myform" action="" onsubmit="template_edit();return false;">
            <textarea id="wzhtml"  name="wzhtml"><?php echo $code;?></textarea>
                <div class="col-sm-4 input-group code-btns">
                    <input type="submit" name="submit" <?php if(!EDIT_TPL) {echo 'value="未开启在线编辑" class="btn btn-warning" disabled';}else{echo 'value="提交" class="btn btn-info rounded-0 fs-6"';}?>>
                </div>
            </form>
            <script>
