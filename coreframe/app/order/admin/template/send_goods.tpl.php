            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-xs-4 control-label">实物卡号</label>
                            <div class="col-sm-9">
                                <textarea name="cardno" class="form-control" cols="60" rows="2" placeholder="多张卡，一行一个"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-xs-4 control-label">备注（管理员可见）</label>
                            <div class="col-sm-9">
                                <textarea name="note" class="form-control" cols="60" rows="1"></textarea>                </div>
                        </div>
                        <div class="form-group">
