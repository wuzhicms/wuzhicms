...
<table cellpadding="2" cellspacing="1" width=100%" class="table table-striped table-advance ">
    <tr>
        <td width="125">选项列表</td>
        <td class="d-flex col-3 pe-3"><textarea name="setting[options]" rows="5" class="form-control" cols="20" id="options" ><?php echo output($setting,'options');?></textarea></td>
    </tr>
    <tr>
        <td>选项类型</td>
        <td>
