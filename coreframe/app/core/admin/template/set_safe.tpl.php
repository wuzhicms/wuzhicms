...
<section class="panel">
    ...
    <div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">安全识别码</label>
                <div class="col-sm-8 form-inline">
                    <input type="text" class="form-control" name="wuzhicms_token" value="<?php echo output($setting,'wuzhicms_token');?>" size="50"> <a href="http://www.wuzhicms.com/api/get_wuzhicms_token.php" target="_blank">获取方式</a>
                </div>
            </div>
            <div class="form-group">
