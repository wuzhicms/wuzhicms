              ...
              <tr>
                ...
                <td class="hidden-phone td5">
                  <div class="col-sm-8">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="form[location]" value="5" >手动表单项 <a href="https://www.wuzhicms.com/doc/field-setting-xianshiweizhi.html" target="_blank"><i class="icon-help"></i> 打开帮助页面</a>
                    </label>
                  </div>
                </td>
              </tr>
