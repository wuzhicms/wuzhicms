...
<?php
if($pid!=0) {
    echo '<div class="panel-body"><a href="?m=core&f=menu&v=listing&pid='.$this->parentid($pid).$this->su().'"><button type="button" class="btn btn-danger">返回上级</button></a></div>';
}
?>
            ...
            <div class="panel-body" id="panel-bodys">
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tr>
                        ...
                        <th class="tablehead">m</th>
                        <th class="tablehead">f</th>
                        <th class="tablehead">v</th>
                    ...
                    foreach($result AS $r) {
                        ...
                        <tr>
                            ...
                            <td><a href="?m=core&f=menu&v=listing&pid=<?php echo $r['menuid'];?><?php echo $this->su();?>"><?php echo $r['name'];?></a> </td>
                            <td><?php echo $r['m'];?></td>
                            <td><?php echo $r['f'];?></td>
                            <td><?php echo $r['v'];?></td>
