                            ...
                            <?php foreach($result AS $r) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        '<span class="label btn-primary label-mini badge">共享模型</span>';} else {echo '<span class="label btn-info label-mini badge">独立模型</span>';}?>
                                    </td>
                                    ...
                                    <td>
                                        <a href="?m=core&f=model&v=field_listing&app=<?php echo $m;?>&modelid=<?php echo $r['modelid'];?><?php echo $this->su();?>"
                                           class="btn btn-info btn-sm btn-xs">字段管理</a>
