...
<section class="panel">
    ...
    <div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            <div class="mb-3 row">
                <label class="col-sm-2 col-xs-4 col-form-label control-label text-end">所属角色</label>
                <div class="col-lg-3 col-sm-4 col-xs-4">
                    <?php
                    echo $form->select(key_value($roles,'role','name'), 0, 'name="form[role][]" class="form-control" multiple="multiple" style="height:200px;"');
                    ?>
                </div>
            </div>
			...
			<div class="mb-3 row">
				...
				<div class="col-lg-3 col-sm-4 col-xs-4">
					...
					echo $form->select($qf_priv, 0, 'name="form[qf_priv]" class="form-select"');
					?>
				</div>
			</div>
            <div class="mb-3 row">
