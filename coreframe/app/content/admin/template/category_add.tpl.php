    ...
    <div id="myTabContent" class="tab-content">
      <div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">名称|英文目录</label>
                            <div class="col-sm-4 input-group">

                                <div id="batch_add">
                                    <textarea class="form-control" maxlength="255" style="height:60px;" datatype="*" errormsg="请输入栏目名称" onblur="set_category(this.value)"></textarea><span class="Validform_checktip"></span><br>例如：<font color="#959595">国内新闻|china<br>国际新闻|world<br></font>竖线以及后面的英文名可留空，默认会自动生成栏目的拼音
                                </div>
                ...
                <?php }?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">是否在栏目列表处显示</label>
                            <div class="col-sm-4 input-group">
                                <input type="radio" name="form[showloop]" value="1" checked=""> 是&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="form[showloop]" value="0"> 否
                            </div>
                        </div>


                        <div class="form-group">
                            <label class="col-sm-2 control-label">是否在导航中显示</label>
                            <div class="col-sm-4 input-group">
                                    <input type="radio" name="form[ismenu]" value="1" checked=""> 是&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" name="form[ismenu]" value="0"> 否
                            </div>
                        </div>
      </div>
      <div role="tabpanel" class="tab-pane fade" id="tabs2" aria-labelledby="2tab">
       <div class="form-group">
                            <label class="col-sm-2 control-label">栏目页生成静态</label>
                            <div class="col-sm-4 input-group">
                                <input type="radio" name="form[listhtml]" value="1"  onclick="change_listhtml(1);"> 是&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="form[listhtml]" value="0" checked onclick="change_listhtml(0);"> 否
                            </div>
                        </div>
                <?php
                if($type==0) {
                ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">内容页生成静态</label>
                            <div class="col-sm-4 input-group">
                                <input type="radio" name="form[showhtml]" value="1"  onclick="change_showhtml(1);"> 是&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="form[showhtml]" value="0" checked onclick="change_showhtml(0);"> 否
                            </div>
                        </div>
<?php }?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">栏目页URL规则</label>
                ...
                ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">内容页URL规则</label>
                            <div class="col-sm-7 input-group m-bot15">
      ...
      <div class="form-group">
                            <label class="col-sm-2 control-label">大栏目页模版</label>
                            <div class="col-sm-4 input-group">
                                <?php
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">终级栏目页模版</label>
                            <div class="col-sm-4 input-group">
                                <?php
                ...
                ?>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">内容页模版</label>
                            <div class="col-sm-4 input-group">
                                <?php
...
<?php }?>
      ...
      <div role="tabpanel" class="tab-pane fade" id="tabs4" aria-labelledby="4tab">
        <div class="form-group">
                            <label class="col-sm-2 control-label">SEO 标题</label>
                            <div class="col-sm-4 input-group">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">SEO 网页描述</label>
                            <div class="col-sm-4 input-group">
