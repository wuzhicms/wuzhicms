                    ...
                    <form class="form-horizontal tasi-form" method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 input-group">
                                <label style="padding-right: 15px;"><input name="type" type="radio" value="1"  onclick="change_type(this.value);"> 列表</label>
                                <label style="padding-right: 15px;"><input name="type" type="radio" value="2" onclick="change_type(this.value);" checked> 代码</label>
                                    <label style="padding-right: 15px;"><input name="type" type="radio" value="3" onclick="change_type(this.value);"> RSS</label>
                                        <label style="padding-right: 15px;"><input name="type" type="radio" value="4" onclick="change_type(this.value);"> JSON</label>
...
{/wz}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 input-group">
                                <label style="padding-right: 15px;"><input name="createhtml" type="radio" value="1" checked> 是 － 生成html页面</label>
                                <label style="padding-right: 15px;"><input name="createhtml" type="radio" value="0"> 否 （通用标签不受此限制可调用）</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">使用云端ID</label>
                            <div class="col-sm-8 input-group">
                                <label style="padding-right: 15px;"><input name="isopenid" type="radio" value="1" > 是</label> （如果需要对外发布该内容，请选择该项，<a href="?m=core&f=set&v=safe<?php echo $this->su();?>">配置安全识别码</a>）
