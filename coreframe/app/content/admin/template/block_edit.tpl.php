...
<section class="wrapper">
    <section class="panel">
        ...
        <div class="bg-light py-2 px-3">修改</div>
        <div class="panel-body">
                    <form class="form-horizontal tasi-form" method="post" action="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-auto d-flex align-items-center pt-2">
                                <div class="form-check me-3 form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="flexRadioDefault1" value="1"  onclick="change_type(this.value);" <?php if($r['type']==1) echo "checked";?>>
                                    <label class="form-check-label" for="flexRadioDefault1">列表</label>
                                </div>
                                <div class="form-check me-3 form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="flexRadioDefault2" value="2"  onclick="change_type(this.value);" <?php if($r['type']==2) echo "checked";?>>
                                    <label class="form-check-label" for="flexRadioDefault2">代码</label>
                                </div>
                                <div class="form-check me-3 form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="flexRadioDefault3" value="3"  onclick="change_type(this.value);" <?php if($r['type']==3) echo "checked";?>>
                                    <label class="form-check-label" for="flexRadioDefault3">RSS</label>
                                </div>
                                <div class="form-check me-3 form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="flexRadioDefault4" value="4"  onclick="change_type(this.value);" <?php if($r['type']==4) echo "checked";?>>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" name="form[name]" datatype="*"  errormsg="请输入标题" value="<?php echo $r['name'];?>">
                            </div>
                        </div>
                        <div class="mb-3 row hide" id="models">
                            <label class="col-sm-2 col-xs-4 control-label col-form-label text-end">绑定模型</label>
                            <div class="col-auto">
                                <?php echo WUZHI_form::select(key_value($models,'modelid','name'), $r['modelid'], 'name="modelid" class="form-select "', '--不限模型--');?>
                            </div>
                        </div>
                        <div class="mb-3 row hide" id="rssid">
                            <label class="col-sm-2 col-xs-4 control-label col-form-label text-end">RSS源</label>
                            <div class="col-5">
                                <input type="text" class="form-control" name="form[rssurl]" datatype="url|*0-100"  errormsg="请输入正确的网址！" value="<?php echo $r['url'];?>">
                            </div>
                        </div>
                        <div class="mb-3 row hide" id="jsonid">
                            <label class="col-sm-2 col-xs-4 control-label col-form-label text-end">JSON源</label>
                            <div class="col-5">
                                <input type="text" class="form-control" name="form[jsonurl]" datatype="url|*0-100"  errormsg="请输入正确的网址" value="<?php echo $r['url'];?>">
                            </div>
                        </div>
                        <div class="mb-3 row" id="template_codeid">
                            <label class="col-sm-2 col-xs-4 control-label col-form-label text-end">模版</label>
                            <div class="col-auto">
                                <textarea type="text" class="form-control" id="template_code" name="form[template_code]" rows="12"><?php if($r['type']!=2) echo p_htmlspecialchars($r['code']);?></textarea>
                        ...
                        <div class="mb-3 row " id="codeid">
                            ...
                            <div class="col-5">
                                <textarea name="form[code]" id="code" class="form-control" rows="10"><?php echo $r['code'];?></textarea>
                                <div class="alert alert-info fade in">
                                    <strong>使用技巧:</strong> 编辑器会自动在代码中增加段落 &lt;P&gt;&lt;/P&gt;，可通过切换为文本框来输入。 <p id="destroy"  onclick="destroy()" class="btn btn-sm btn-xs btn-inverse"> <?php if($r['codetype']) echo '切换为文本框';else echo '切换为编辑器';?></p>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row">
