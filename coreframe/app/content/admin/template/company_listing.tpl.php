                 ...
                 <span class="dropdown examine">
                    ...
                    <form class="pull-right position" action="" method="get">
                        ...
                        <div class="input-append dropdown">
                            <input type="text" name="title" placeholder="搜索公司名称" class="sr-input" value="<?php echo $title;?>">
                    ...
                    <form name="myform" id="myform" method="post" action="?m=content&f=content&v=sort<?php echo $this->su();?>">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th class="tablehead">公司名称</th>
                                <th class="tablehead">公司性质</th>
                                <th class="tablehead">所属用户</th>
                            ...
                            <?php foreach($result AS $r) {
                                $mr = $this->db->get_one('member', array('uid' => $r['owner']));
                                ?>
                                <tr title="<?php echo $models[$r['modelid']]['name'];?>">
                                    ...
                                    <td><?php echo $r['xz'];?></td>
                                    <td><?php echo $mr['username'];if($mr['ext_groupid1'] && $mr['checkmec']) {echo ' - 已认证';}?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="?m=content&f=content&v=view&id=<?php echo $r['id'];?>&cid=<?php echo $r['cid'];?><?php echo $this->su();?>" target="_blank" class="btn btn-default btn-xs">详情</a>
