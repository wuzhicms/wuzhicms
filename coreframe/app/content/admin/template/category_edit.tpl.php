                    ...
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active show" id="tabs1" aria-labelledby="1tab">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 d-flex justify-content-center">
                                    <?php
                                    echo $form->select(key_value($models, 'modelid', 'name'), $r['modelid'], 'name="form[modelid]" class="form-select" datatype="*" errormsg="请选择模型！"', "≡ 请选择模型 ≡");
                                    ?>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    ...
                                    echo $form->tree_select($categorys, $r['pid'], 'name="form[pid]" class="form-select" onchange="check_parent(this.value)"', '≡ 无上级栏目 ≡', $cid);
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-xs-4 control-label col-form-label text-end">英文目录</label>
                                <div class="col-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <div class="upload-picture-card"><?php echo $form->attachment('', '1', 'form[icon]', $r['icon']); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    ...
                                    echo $form->select(key_value($workflow, 'workflowid', 'name'), $r['workflowid'], 'name="form[workflowid]" class="form-select"', '≡ 无需审核 ≡');

                                    ?>
                                </div>
                            </div>
                            <div class="row mb-3 <?php if ($r['pid']) echo 'hide'; ?>" id="domain-div">
                                ...
                                <div class="col-3">
                                    ...
                                    <span class="help-block"><i class="icon-info-circle"></i> 可绑定任意域名：格式为：http://www.wuzhicms.com/ ，绑定域名后，生成静态规则将使用默认规则</span>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <div class="input-group">
                                        ...
                                        <ul id="phpurlruleid" class="dropdown-menu dropdown-menu-end dropdown-menu-dark <?php if ($r['listhtml']) echo "hide"; ?>"">
                                        ...
                                        <ul id="htmlurlruleid" class="dropdown-menu dropdown-menu-end dropdown-menu-dark <?php if (!$r['listhtml']) echo "hide"; ?>"">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">选择规则 </button>
                                        <ul id="phpurlruleid2" class="dropdown-menu dropdown-menu-end dropdown-menu-dark <?php if ($r['showhtml']) echo "hide"; ?>">
                                        ...
                                        <ul id="htmlurlruleid2" class="dropdown-menu dropdown-menu-end dropdown-menu-dark <?php if (!$r['showhtml']) echo "hide"; ?>" "">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tabs3" aria-labelledby="3tab">
                            <div class="align-items-center mb-3 row">
                                ...
                                <div class="col-3">
                                    <?php
                                    echo $form->templates('content', $r['category_template'], 'name="form[category_template]" class="form-select"');
                                    ?>
                                </div>
                            ...
                            <div class="align-items-center row mb-3">
                                ...
                                <div class="col-3">
                                    <?php
                                    echo $form->templates('content', $r['list_template'], 'name="form[list_template]" class="form-select"');
                                    ?>
                                </div>
                            ...
                            <div class="align-items-center row mb-3">
                                ...
                                <div class="col-3">
                                    <?php
                                    echo $form->templates('content', $r['show_template'], 'name="form[show_template]" class="form-select"');
                                    ?>
                                </div>
                            </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tabs4" aria-labelledby="4tab">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3">
                                    <textarea type="text" class="form-control" rows="4" name="form[seo_description]" value="<?php echo $r['seo_description']; ?>"><?php echo $r['seo_description']; ?></textarea>
                                </div>
                            </div>
                        </div>
