    ...
    <div class="panel-body">
        <form class="form-horizontal tasi-form" method="post" action="">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                    <input type="text" name="form[title_en]" maxlength="80" class="form-control" value="<?php echo $r['title_en'];?>" datatype="*" errormsg="请填写课程名—英文" nullmsg="请填写课程名—英文！"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">教室</label>
                <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                    <input type="text" name="form[classroom]" maxlength="80" class="form-control" value="<?php echo $r['classroom'];?>" datatype="*" errormsg="请填写所在教室" nullmsg="请填写所在教室！"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">教室—英文</label>
                <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                    <input type="text" name="form[classroom_en]" maxlength="80" class="form-control" value="<?php echo $r['classroom_en'];?>" datatype="*" errormsg="请填写所在教室—英文" nullmsg="请填写所在教室—英文！"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">讲师</label>
                <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                    <input type="text" name="form[teacher]" maxlength="80" class="form-control" value="<?php echo $r['teacher'];?>" datatype="*" errormsg="请填写讲师" nullmsg="请填写讲师！"/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-xs-4 control-label">讲师—英文</label>
                <div class="col-lg-8 col-sm-8 col-xs-8 input-group">
                    <input type="text" name="form[teacher_en]" maxlength="80" class="form-control" value="<?php echo $r['teacher_en'];?>" datatype="*" errormsg="请填写讲师—英文" nullmsg="请填写讲师—英文！"/>
                </div>
            </div>
