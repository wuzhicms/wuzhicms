                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-6">
                        <div class="input-group">
                            <input type="text" style="<?php echo $r['css'];?>" name="form[title]" id="title" maxlength="80" class="form-control" value="<?php echo $r['title'];?>"/>
                            <span class="input-group-text p-0 border-0"><input type="hidden" id="title_css" name="title_css" value="<?php echo $color;?>"><img id="title_color" src="<?php echo R;?>libs/colorpicker/picker.png" height="30" hx="#c00"></span>
                            <span class="input-group-text p-0 border-0"><input type="hidden" name="font_weight" id="font_weight" value="<?php echo $font_weight;?>"><button class="btn btn-white" type="button" onclick="change_fontweight();"><strong>B</strong></button></span>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-6">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[status]" id="status1" value="1" <?php if($r['status']==1) echo 'checked';?>>
                            <label class="form-check-label" for="status1">注册会员</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[status]" id="status2" value="2" <?php if($r['status']==2) echo 'checked';?>>
                            <label class="form-check-label" for="status2">会员+游客</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="form[status]" id="status3" value="3" <?php if($r['status']==3) echo 'checked';?>>
