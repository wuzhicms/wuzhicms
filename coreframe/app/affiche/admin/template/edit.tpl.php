                    ...
                    <form class="form-horizontal tasi-form" method="post" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 input-group">
                                <label class="radio-inline"> <input type="radio" name="form[status]" value="1" <?php if($r['status']==1) echo 'checked';?>> 注册会员</label>
                                <label class="radio-inline"> <input type="radio" name="form[status]" value="2" <?php if($r['status']==2) echo 'checked';?>> 会员+游客</label>
                                <label class="radio-inline"> <input type="radio" name="form[status]" value="3" <?php if($r['status']==3) echo 'checked';?> disabled> 后台管理员</label>
                            </div>
                        </div>
                        <div class="form-group">
