        ...
        <form class="form-horizontal tasi-form" method="post" action="">
            <div class="form-group">
                ...
                <div class="col-sm-8 input-group">
                    <input type="text" name="form[title]" id="title" maxlength="80" class="form-control" value="<?php echo $r['title'];?>"/><span class="input-group-btn"><input type="hidden" id="title_css" name="title_css" value=""><img id="title_color" src="<?php echo R;?>js/colorpicker/picker.png" height="34" hx="#c00"></span><span class="input-group-btn"><input type="hidden" name="font_weight" id="font_weight" value=""><button class="btn btn-white" type="button" onclick="change_fontweight();"><strong>B</strong></button></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">公告群体</label>
                <div class="col-sm-8 input-group">
                    <label style="width: 100px;"> <input type="radio" name="form[status]" value="1" checked> 注册会员</label>
                    <label style="width: 100px;"> <input type="radio" name="form[status]" value="2" > 会员+游客</label>
                    <label style="width: 100px;"> <input type="radio" name="form[status]" value="3" disabled> 后台管理员</label>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">公告结束时间</label>
            ...
            <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label">公告备注（管理员可见）</label>
                <div class="col-sm-9 input-group">
