...
INSERT INTO `wz_model_field` (`modelid`, `field`, `name`, `remark`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `ext_code`, `unsetgids`, `unsetroles`, `master_field`, `ban_field`, `location`, `search_field`, `ban_contribute`, `to_fulltext`, `to_block`, `sort`, `disabled`, `powerful_field`, `workflow_field`) VALUES
  ...
  (2, 'block', '添加到区块', '', '', 0, 0, '', '', 'block', '', '', '', '', 1, 0, 0, 0, 0, 0, 0, 10, 0, 0, 0),
...
ALTER TABLE `wz_setting` ADD `title` VARCHAR(80) NOT NULL COMMENT '含义，标题' AFTER `v`;
INSERT INTO `wz_menu`(`name`,`pid`,`m`,`f`,`v`,`data`,`display`,`menuid`) VALUES ('自定义全局变量','2','core','set','global_vars','','1','5001');
INSERT INTO `wz_menu`(`name`,`pid`,`m`,`f`,`v`,`data`,`display`,`menuid`) VALUES ('添加自定义变量','5001','core','set','add_global_vars','','1','5002');
INSERT INTO `wz_menu`(`name`,`pid`,`m`,`f`,`v`,`data`,`display`,`menuid`) VALUES ('修改自定义变量','5001','core','set','edit_global_vars','','0','5003');
