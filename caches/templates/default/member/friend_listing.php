                ...
                <div class="memberbordertop">
                    <section class="panel">
                        ...
                        <ul id="myTab" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active"><a href="#tabs1" id="1tab" role="tab" data-toggle="tab" aria-controls="tabs1" aria-expanded="true">为你推荐</a></li>
                            <?php } ?>
                            <li role="presentation" <?php if($this->memberinfo['modelid']==23) { ?>class="active"<?php } ?>><a href="?m=member&f=friend&v=myfriend">我的好友</a></li>
                            <li role="presentation" class=""><a href="?m=member&f=friend&v=myfans">我的粉丝</a></li>
                                        ...
                                        <?php if(($n-1)%3==0) { ?><tr><?php } ?>
                                            <td class="friendblock">
                                                <div class="friendli">
                                                    ...
                                                    <?php if($r['rtype']==1 ||$r['rtype']==2) { ?><span class="btn" onclick="cancelgz(<?php echo $r['uid'];?>,this)">取消关注</span><?php } ?>
