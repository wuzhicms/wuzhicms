...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="#tabs1" id="1tab" role="tab" data-toggle="tab" aria-controls="tabs1" aria-expanded="true">修改稿件</a></li>
                        </li>
                    </ul>
...
<textarea class="form-control" name="form[content]" rows="10" datatype="*50-10000" nullmsg="请输入正文" errormsg="正文至少50个字符,最多10000个字符！"><?php echo $data['content'];?></textarea>
                                                </div></div></td>
                                            </tr>


                                            <tr>
                                                <td><div class="form-groupinfo"><label class="col-sm-2 control-label text-right"> </label><div class="col-sm-3 text-left"><input type="submit" name="submit" id="submit" value="更新稿件" class="btn btn-primary"></div></div></td>
                                            </tr>
                                        </table>
                                    </form>
                        </div>
