            ...
            <div class="memberright">
                ...
                <div class="memberbordertop">
                    <section class="panel">
                        ...
                        <div class="submitbtn"><a href="?m=content&f=cominfo&v=newinfo" class="btn">免费发布信息</a></div>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
                                <div class="panel-body" id="panel-bodys">
                                    <table class="table table-striped table-advance table-hover text-center">
                                        ...
                                        <tr>
                                            <td colspan="3" class="text-left mysubmit"><span class="uptime">更新时间: <?php echo date('Y-m-d H:i:s',$r['updatetime']);?></span> <span class="number">编号：<?php echo $r['id'];?></span> <span class="pull-right"><a href="?m=content&f=cominfo&v=editinfo&id=<?php echo $r['id'];?>" class="btn btn-order">修改</a> <a href="?m=content&f=cominfo&v=delinfo&id=<?php echo $r['id'];?>"  class="btn btn-del">删除</a></span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($r['status']==9) { ?>
                                                <a href="javascript:referer(<?php echo $r['id'];?>);" class="btn btn-white">刷新</a>
                                                <a href="javascript:settop(<?php echo $r['id'];?>);" class="btn btn-white">置顶</a><?php } ?></td>
                                        </tr>
<?php $n++;}?>
                                        </tbody>
                                    </table>
...
<script>
    function referer(id) {
        var d = dialog({
            title: '提示',
            content: '刷新将消耗您<?php echo $point_config['cominfo_f5'];?>点积分',
            okValue: '确定',
            ok: function () {
                $.post("?m=content&f=cominfo&v=referer", { id: id, time: "2pm" },
                        function(data){
                            if(data==1) {
                                var xb = dialog({
                                    content: '刷新成功！'
