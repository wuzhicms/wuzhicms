...
<link type="text/css" rel="stylesheet" href="<?php echo R;?>css/tijiancenter_style.css">
    ...
    <div class="dp_left">
     ...
     <div class="panel panel-default">
      <div class="panel-body">
       <p style="padding:16px 16px; border-bottom: 1px  dotted #ddd; color:#999"><span class="color_heyilan font_weight"><a href="<?php echo $data['url'];?>"> <?php echo $data['title'];?></a></span> <span class="font_size12 color_777">&nbsp;&nbsp;&nbsp;&nbsp;点击星星为商户打分(带<span class="color_heyihong"> * </span>为必填项) </span><a href="/mec/<?php echo $city;?>/" class="float_right color_777 font_size12 pading_top_10px">点评其他商户&raquo;</a></p>
       <form name="myform" id="myform" method="post" action="">
        ...
        <tr>
         ...
         <td colspan="2"  style="padding:16px 8px;">总体评价：<span id="star1" class="starWrapper"></span>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;环境：<span id="star2" class="starWrapper"></span> &nbsp;&nbsp;&nbsp;&nbsp;服务：<span id="star3" class="starWrapper"></span></td>
        </tr>
        <tr>
        ...
        <tr>
         <td style="vertical-align:text-top"><div align="right">费用：</div></td>
         <td width="32%"><input type="text" name="form[field4]" class="form-control" placeholder=""></td>
         <td width="53%">元</td>
        </tr>
        <tr>
         <td style="vertical-align:text-top"><div align="right">停车信息：</div></td>
         <td><input type="text" name="form[field6]" class="form-control" placeholder="车停在哪了，收费吗？" width="10px"></td>
         <td>&nbsp;</td>
        </tr>
        <tr>
         <td>&nbsp;</td>
    ...
    <div class="dp_right">
     <div class="media media_add">
      <div class="media-body">
       <h4 style="width:250px;" class="media-heading color_heyilan font_weight manhangyichu"><a href="<?php echo $data['url'];?>"><?php echo $data['title'];?></a></h4>
       总评 <span class="score-value-no" style="display:inline-block" title="<?php echo $data['avg_total'];?>"><em style="width: <?php echo intval($data['avg_total']*20);?>%"></em></span><em class="sep">|</em> 人均 <span class="color_heyihong">￥<?php echo $data['avg_price'];?></span> <br>
      </div>
     </div>
...
<script type="text/javascript">
 ...
 $('#star1').raty({
  score: 5,
  starOff  : '<?php echo R;?>images/xingxing.gif',
  starOn   : '<?php echo R;?>images/xingxingh.gif',
