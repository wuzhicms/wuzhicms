...
define('RES_ROOT',substr(dirname(__FILE__),0,-11).'res'.DIRECTORY_SEPARATOR);
define('CACHE_EXT','GOmAn');
define('WEBSOCKET','');
...
define('WEBURL','http://v5.cmsv5.com/');//网站域名

//Cookie配置
define('COOKIE_DOMAIN','');//Cookie 作用域
define('COOKIE_PATH','/');//Cookie 作用路径
define('COOKIE_PRE','xQs_'); //Cookie 前缀
define('COOKIE_TTL',0); //Cookie 生命周期，0 表示随浏览器进程

//附件相关配置
define('ATTACHMENT_ROOT',WWW_ROOT.'uploadfile/');
define('ATTACHMENT_URL','/uploadfile/');//附件路径
define('R','http://v5.cmsv5.com/res/');//静态文件存储目录
define('_KEY','AoA_F85C'); //密钥,最长8位
...
define('PLURL', 'http://p1.zgw.wuzhicms.com/');//评论发布地址
