	...
	_create: function() {
		...
		if(this.handles.constructor === String) {
			...
			if(n.length>1) {
				...
				if(elementid=='') elementid='该组件缺少id';
				axis = '<div class="edit--list"><div class="edit-btn"><a href="javascript:;" onclick="tools_iframe(\'?m=core&f=layout&v=edit_item&pageid='+pageid+'&elementid='+elementid+_su+'\',\''+elementid+'\',\'标签管理\',800,560);">编辑: '+elementid+'</a></div><div class="del-btn"><a href="javascript:;" onclick="remove_widget(\''+elementid+'\');">删除</a></div></div>';
