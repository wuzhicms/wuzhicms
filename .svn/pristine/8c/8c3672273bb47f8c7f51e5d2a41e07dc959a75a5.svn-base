...
class WUZHI_Uploader
{
    ...
    private function saveRemote()
    {
        ...
        //获取请求头并检测死链
        $heads = get_headers($imgUrl,1);//bug 2014-8-30
    ...
    public function getFileInfo()
    {
        return array(
            ...
            "url" => ATTACHMENT_URL.$this->fullName,
            "title" => $this->fileName,
	...
	private function insert()
	{
		...
		$insert = array();
		$insert['name'] = array_iconv('utf-8',CHARSET,$this->oriName);
		$insert['path'] = $this->fullName;
